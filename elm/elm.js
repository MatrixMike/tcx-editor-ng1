...
Elm.Main.make = function (_elm) {
   ...
   var KVs = function (a) {
      return {ctor: "KVs",_0: a};
   };
   var Arr = function (a) {
      return {ctor: "Arr",_0: a};
   };
   var KV = function (a) {
      return {ctor: "KV",_0: a};
   };
   var a1 = KV({ctor: "_Tuple2"
               ,_0: "a"
               ,_1: "b"});
   var c1 = KV({ctor: "_Tuple2"
               ,_0: "c"
               ,_1: "d"});
   var a2 = Arr(_L.fromArray([a1
                             ,c1]));
   var a4 = KVs(_L.fromArray([a1
                             ,c1]));
   var a3 = KO({ctor: "_Tuple2"
               ,_0: "a"
               ,_1: Arr(_L.fromArray([KV({ctor: "_Tuple2"
                                         ,_0: "b"
                                         ,_1: "c"})]))});
