...
Elm.App.make = function (_elm) {
   ...
   $Upload = Elm.Upload.make(_elm);
   var SetZoom = function (a) {
      return {ctor: "SetZoom"
             ,_0: a};
   };
   var MapLoaded = {ctor: "MapLoaded"};
   var Editor = function (a) {
      return {ctor: "Editor"
             ,_0: a};
   };
   var Uploader = function (a) {
      return {ctor: "Uploader"
             ,_0: a};
   };
   ...
   model) {
      return function () {
         var viewTemplate = function () {
            ...
            switch (_v0.ctor)
            {case "Editing":
               return A2($Editor.view,
                 A2($Signal.forwardTo,
                 address,
                 Editor),
                 model.data);
               case "ErrorState":
               return $Html.text("Error");
               case "Uploading":
               return A2($Upload.view,
                 A2($Signal.forwardTo,
                 address,
                 Uploader),
                 model.data);}
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([]),
                      _L.fromArray([$Html.text("Garmin GPS .tcx editor")]))]))]))
                      ,viewTemplate
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("logo-container")]),
                      _L.fromArray([A2($Html.a,
                      _L.fromArray([$Html$Attributes.href("http://www.elm-lang.org")]),
                      _L.fromArray([A2($Html.img,
                                   _L.fromArray([$Html$Attributes.src("ElmLogo.png")]),
                                   _L.fromArray([]))
                                   ,A2($Html.p,
                                   _L.fromArray([]),
                                   _L.fromArray([$Html.text("Built with Elm")]))]))]))]));
      }();
   });
   ...
   var ErrorState = {ctor: "ErrorState"};
   var Editing = {ctor: "Editing"};
   var Transitioning = {ctor: "Transitioning"};
   var Uploading = {ctor: "Uploading"};
   var init = {_: {}
              ,data: $Upload.init
              ,state: Uploading
              ,zoom: 12};
            ...
            switch (action._0.ctor)
              {case "Ready":
                 return {ctor: "_Tuple2"
                        ...
                        ,_1: $Effects.none};}
              return function () {
                 var tmp = A2($Upload.update,
                 action._0,
                 model.data);
                 var newModel = _U.replace([["data"
                                            ,$Basics.fst(tmp)]],
                 model);
                 return {ctor: "_Tuple2"
                        ,_0: newModel
...
Elm.Editor.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SummaryInfo = Elm.SummaryInfo.make(_elm),
   $TcxDecoder = Elm.TcxDecoder.make(_elm),
   $Upload = Elm.Upload.make(_elm);
   var update = F2(function (action,
   model) {
      return {ctor: "_Tuple2"
   ...
   var viewTP = F4(function (address,
   lapIdx,
   tpIdx,
   tp) {
      return A2($Html.tr,
      _L.fromArray([$Html$Attributes.$class("track-point")
                   ,A2($Html$Events.onClick,
                   address,
                   A2(Click,lapIdx,tpIdx))]),
      _L.fromArray([A2($Html.td,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(A2($Date$Format.format,
                   "%k:%M:%S",
                   tp.time))]))
                   ,A2($Html.td,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(A2($Basics._op["++"],
                   $Basics.toString($Basics.round(tp.distance)),
                   " m"))]))]));
   });
   var viewLap = F3(function (address,
   lapIdx,
   lap) {
      return A2($Html.div,
      ...
      _L.fromArray([A2($Html.strong,
                   ...
                   _L.fromArray([$Html.text(A2($Basics._op["++"],
                   "Lap ",
                   $Basics.toString(lapIdx)))]))
                   ,$Html.table(_L.fromArray([]))(A2($List._op["::"],
                   A2($Html.tr,
                   _L.fromArray([$Html$Attributes.$class("table-header")]),
                   _L.fromArray([A2($Html.th,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Timestamp")]))
                                ,A2($Html.th,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Accum Dist.")]))])),
                   A2($List.indexedMap,
                   A2(viewTP,address,lapIdx),
                   lap.tps)))]));
   });
   var viewLaps = F2(function (address,
   laps) {
      return $Html.div(_L.fromArray([$Html$Attributes.$class("laps")]))(A2($List.indexedMap,
      viewLap(address),
      laps));
   });
   var MapLoaded = {ctor: "MapLoaded"};
   var onLoad = function (address) {
   ...
   var GotoUpload = {ctor: "GotoUpload"};
   var view = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("editor row")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-xs-12")]),
                   _L.fromArray([$SummaryInfo.summaryInfo(model.json)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-xs-12")]),
                   _L.fromArray([A2($Html.h2,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Trackpoint data")]))
                                ,$English.trackpoint]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-xs-5 trackpoints")]),
                   _L.fromArray([A2(viewLaps,
                   address,
                   model.json)]))
                   ,A2($Html.div,
                   ...
                   _L.fromArray([$Html$Attributes.$class("btn btn-primary")
                                ...
                                address,
                                GotoUpload)]),
                   _L.fromArray([$Html.text("Load new data")]))]))]));
   });
...
Elm.English = Elm.English || {};
Elm.English.make = function (_elm) {
   "use strict";
   _elm.English = _elm.English || {};
   if (_elm.English.values)
   return _elm.English.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var trackpoint = A2($Html.p,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Choose \'trackpoints\' to delete from the rows below or click on the map (not the markers). Use Shift+Click to select multiple rows.")]));
   var intro = A2($Html.div,
   _L.fromArray([]),
   _L.fromArray([A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("Ever left your Garmin running at the end of a ride? All your hard earned averages declined pointlessly?")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("This simple editor enables you to delete points from a file, recalculates aggregate ride data, and returns a new copy of the file.")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("To start, upload a \'.tcx\' file. You can convert a .fit file to .tcx using ")
                             ,A2($Html.a,
                             _L.fromArray([$Html$Attributes.href("http://connect.garmin.com/")]),
                             _L.fromArray([$Html.text("Garmin Connect\'s")]))
                             ,$Html.text(" export functionality.")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([A2($Html.strong,
                             _L.fromArray([]),
                             _L.fromArray([$Html.text("Note: ")]))
                             ,$Html.text("This app is tested with Edge 800 (firmware 2.6) data. YMMV, but other users (including with Garmin 610) report success.")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("No copy of the data processed is kept.")]))]));
   _elm.English.values = {_op: _op
                         ,intro: intro
...
Elm.FileReader.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var getTextFile = $Native$FileReader.getTextFile;
   var NoFileSpecified = {ctor: "NoFileSpecified"};
   var ReadFail = {ctor: "ReadFail"};
...
Elm.SummaryInfo = Elm.SummaryInfo || {};
Elm.SummaryInfo.make = function (_elm) {
   "use strict";
   _elm.SummaryInfo = _elm.SummaryInfo || {};
   if (_elm.SummaryInfo.values)
   return _elm.SummaryInfo.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "SummaryInfo",
   $Basics = Elm.Basics.make(_elm),
   $Date$Format = Elm.Date.Format.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $TcxDecoder = Elm.TcxDecoder.make(_elm);
   var toKmh = function (ms) {
      return ms * 60 * 60 / 1000;
   };
   var roundFloat = F2(function (n,
   x) {
      return function () {
         var nn = $Basics.toFloat(Math.pow(10,
         n));
         return $Basics.toFloat($Basics.round(x * nn)) / nn;
      }();
   });
   var lapSummary = F2(function (lapIdx,
   lap) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row lap")]),
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                   _L.fromArray([$Html.text(A2($Basics._op["++"],
                   $Basics.toString($Basics.round(lap.totalTime)),
                   " s"))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                   _L.fromArray([$Html.text(A2($Basics._op["++"],
                   $Basics.toString(A2(roundFloat,
                   2,
                   lap.distance / 1000)),
                   " km"))]))
                   ,A2($Html.div,
                   ...
                   $Basics.toString(A2(roundFloat,
                   1,
                   toKmh(lap.averageSpeed))),
                   " km/h"))]))]));
   });
   var summaryHeader = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("row headers")]),
   _L.fromArray([A2($Html.div,
                _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                _L.fromArray([]))
                ,A2($Html.div,
                _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                _L.fromArray([$Html.text("Start time")]))
                ,A2($Html.div,
                _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                _L.fromArray([$Html.text("Time")]))
                ,A2($Html.div,
                _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                _L.fromArray([$Html.text("Distance")]))
                ,A2($Html.div,
                _L.fromArray([$Html$Attributes.$class("col-xs-2")]),
                _L.fromArray([$Html.text("Avg speed")]))]));
   var summaryInfo = function (laps) {
      return function () {
         var _ = laps;
         var lap1 = function () {
            switch (_.ctor)
            {case "::": return _._0;}
            _U.badCase($moduleName,
            "on line 19, column 23 to 27");
         }();
         return $Html.div(_L.fromArray([$Html$Attributes.$class("summary")]))(A2($List._op["::"],
         A2($Html.h3,
         _L.fromArray([]),
         _L.fromArray([$Html.text(A2($Basics._op["++"],
         "Summary of ride (",
         A2($Basics._op["++"],
         A2($Date$Format.format,
         "%e %B %Y",
         lap1.startTime),
         ")")))])),
         A2($List._op["::"],
   ...
   _elm.SummaryInfo.values = {_op: _op
...
Elm.TcxDecoder = Elm.TcxDecoder || {};
Elm.TcxDecoder.make = function (_elm) {
   "use strict";
   _elm.TcxDecoder = _elm.TcxDecoder || {};
   if (_elm.TcxDecoder.values)
   return _elm.TcxDecoder.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TcxDecoder",
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var xtractDate = function (fieldname) {
   ...
   var lxDecoder = A2($Json$Decode._op[":="],
   "LX",
   A2($Json$Decode.tuple1,
   $Basics.identity,
   xtractFloat("AvgSpeed")));
   var extensionsDecoder = A2($Json$Decode._op[":="],
   "Extensions",
   A2($Json$Decode.tuple1,
   $Basics.identity,
   lxDecoder));
   ...
   b) {
      return {_: {},lat: a,lng: b};
   });
   var posDecoder = A3($Json$Decode.object2,
   Position,
   xtractFloat("LatitudeDegrees"),
   xtractFloat("LongitudeDegrees"));
   var Trackpoint = F3(function (a,
   b,
   c) {
      return {_: {}
             ,distance: c
   ...
   var tpDecoder = A4($Json$Decode.object3,
   Trackpoint,
   xtractDate("Time"),
   A2($Json$Decode._op[":="],
   "Position",
   ...
   var trackDecoder = A2($Json$Decode._op[":="],
   "Track",
   A2($Json$Decode.tuple1,
   $Basics.identity,
   A2($Json$Decode._op[":="],
   "Trackpoint",
   $Json$Decode.list(tpDecoder))));
   var Lap = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var lapDecoder = A6($Json$Decode.object5,
   Lap,
   A2($Json$Decode.at,
   _L.fromArray(["$"]),
   ...
   trackDecoder,
   extensionsDecoder);
   var activityDecoder = A2($Json$Decode._op[":="],
   "Lap",
   $Json$Decode.list(lapDecoder));
   var activitiesDecoder = A2($Json$Decode._op[":="],
   "Activity",
   A2($Json$Decode.tuple1,
   $Basics.identity,
   activityDecoder));
   var tcxDecoder = $Json$Decode.at(_L.fromArray(["TrainingCenterDatabase"
                                                 ,"Activities"]))(A2($Json$Decode.tuple1,
   $Basics.identity,
   activitiesDecoder));
   _elm.TcxDecoder.values = {_op: _op
                            ,tcxDecoder: tcxDecoder
                            ,Lap: Lap
                            ,Trackpoint: Trackpoint
                            ,Position: Position};
   return _elm.TcxDecoder.values;
};
Elm.TcxEditor = Elm.TcxEditor || {};
Elm.TcxEditor.make = function (_elm) {
   "use strict";
   _elm.TcxEditor = _elm.TcxEditor || {};
   if (_elm.TcxEditor.values)
   return _elm.TcxEditor.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TcxEditor",
   ...
   $Task = Elm.Task.make(_elm),
   $TcxDecoder = Elm.TcxDecoder.make(_elm);
   var zoom = Elm.Native.Port.make(_elm).inboundSignal("zoom",
   "Int",
   function (v) {
      return typeof v === "number" ? v : _U.badPort("a number",
      v);
   });
   var indexedFilter = F2(function (p,
   xs) {
      return function () {
         var tup = A3($List.map2,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
   ...
   var helper = function (model) {
      return function () {
         var fullList = A2($List.concatMap,
         function ($) {
         ...
         model.data.json);
         var skipRate = $Basics.round(-3.4 * $Basics.toFloat(model.zoom) + 66);
         return A2(indexedFilter,
         F2(function (i,_v4) {
            return function () {
   ...
   app.tasks);
   var mapdiv = Elm.Native.Port.make(_elm).outboundSignal("mapdiv",
   function (v) {
      return v;
   },
   ...
   app.model)));
   var gmap = Elm.Native.Port.make(_elm).outboundSignal("gmap",
   function (v) {
...
Elm.Upload = Elm.Upload || {};
Elm.Upload.make = function (_elm) {
   "use strict";
   _elm.Upload = _elm.Upload || {};
   if (_elm.Upload.values)
   return _elm.Upload.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $TcxDecoder = Elm.TcxDecoder.make(_elm);
   var rootUrl = "";
   var readfileErrorHandler = function (err) {
      return function () {
         switch (err.ctor)
   ...
   var converterErrorHandler = function (err) {
      return function () {
         switch (err.ctor)
   ...
   var sendToRemote = function (raw) {
      return $Effects.task($Task.map(JsonData)($Task.toResult(A3($Http.post,
      $TcxDecoder.tcxDecoder,
      A2($Basics._op["++"],
      rootUrl,
      "/tcx"),
   ...
   var getDemoData = $Effects.task($Task.map(JsonData)($Task.toResult(A2($Http.get,
   $TcxDecoder.tcxDecoder,
   A2($Basics._op["++"],
   rootUrl,
   "/tcx/demo")))));
   var FileData = function (a) {
      return {ctor: "FileData"
             ,_0: a};
   };
   var loadData = $Effects.task($Task.map(FileData)(A2($Task.onError,
   $FileReader.getTextFile("input"),
   function (err) {
      return $Task.succeed(readfileErrorHandler(err));
   })));
   var update = F2(function (action,
   model) {
      return function () {
         ...
         {case "Demo":
            ...
            return {ctor: "_Tuple2"
                   ,_0: _U.replace([["raw"
                                    ,action._0]],
                   model)
                   ,_1: sendToRemote(action._0)};
            case "JsonData":
            return function () {
                 switch (action._0.ctor)
                 {case "Err":
                    return {ctor: "_Tuple2"
                           ,_0: _U.replace([["errorMessage"
                                            ,converterErrorHandler(action._0._0)]],
                           model)
                           ,_1: $Effects.none};
                    case "Ok":
                    return {ctor: "_Tuple2"
                           ,_0: _U.replace([["json"
                                            ,action._0._0]],
                           model)
                           ,_1: $Effects.task($Task.succeed(Ready))};}
                 _U.badCase($moduleName,
   ...
   var Demo = {ctor: "Demo"};
   var Upload = {ctor: "Upload"};
   var view = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("upload row")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-xs-6")]),
                   _L.fromArray([$English.intro
                                ,A2($Html.div,
                                _L.fromArray([]),
                                _L.fromArray([A2($Html.span,
                                             _L.fromArray([$Html$Attributes.$class("btn btn-default btn-file")]),
                                             _L.fromArray([$Html.text("Find file")
                                                          ,A2($Html.input,
                                             ...
                                             _L.fromArray([$Html.text("Upload")]))
                                             ,A2($Html.div,
                                             _L.fromArray([$Html$Attributes.$class("error-message")]),
                                             _L.fromArray([$Html.text(model.errorMessage)]))]))
                                ,A2($Html.button,
                                _L.fromArray([A2($Html$Events.onClick,
                                             address,
                                             Demo)
                                             ,$Html$Attributes.$class("btn btn-success")]),
                                _L.fromArray([$Html.text("Demo")]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("img-container col-xs-6")]),
                   _L.fromArray([A2($Html.img,
                   _L.fromArray([$Html$Attributes.src("editor.png")]),
                   _L.fromArray([]))]))]));
   });
   var init = {_: {}
              ,errorMessage: ""
